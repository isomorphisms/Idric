    ...
    = do opts <- get ROpts
         case evalResultName opts of
            ...
            Just n =>
              ...
              pure [ Elaborable_Claim
                       (MkFCVal replFC $ Make_Elaborable_Claim_Data top Private []
                                       $ Mk [replFC, NoFC it] (Implicit replFC False))
                  , Elaborable_Definition replFC it [PatClause replFC (Elaborable_Name replFC it) (Elaborable_Name replFC n)]]
...
inferAndElab emode itm env
  = do ttimp <- desugar AnyExpr (toList vars) itm
       let ttimpWithIt = Elaborable_Local_Definitions replFC !getItDecls ttimp
